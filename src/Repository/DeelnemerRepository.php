 ...
 * @method Deelnemer[]    findBySearchField($value)
 */
class DeelnemerRepository extends ServiceEntityRepository
{
    ...
    /**
     * @return Deelnemer[] Returns an array of Deelnemer objects
     */
    public function findBySearchField($value)
    {
        return $this->createQueryBuilder('d')
            ->andWhere('d.last_name LIKE :val')
    ...
    /*
    public function findOneBySomeField($value): ?Deelnemer
    {
        return $this->createQueryBuilder('d')
